...
import rocha.andre.api.domain.fullGame_mobile.DTO.FullGameInfoDTO;
...
public class GetFullGameInfoService {
    ...
    public FullGameReturnDTO getFullGameInfo(String gameId) {
        ...
        return new FullGameReturnDTO(game, gameStudio, gameGenre, gameConsole);
    }
}
