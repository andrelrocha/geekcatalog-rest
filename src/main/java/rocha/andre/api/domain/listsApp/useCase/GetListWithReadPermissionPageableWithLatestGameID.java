...
@Component
public class GetListWithReadPermissionPageableWithLatestGameID {
    @Autowired
    ...
    public Page<ListAppReturnWithGameIdsDTO> getAllListsWithReadPermissionWithGamesID(String userId, Pageable pageable) {
        ...
        try {
            ...
            var pageWithLatestGame = listsWithReadPermissionToUser.map(listApp -> {
